...
namespace BusinessLayer
{
    public class UsersRepository
    {
        ...
        public UsersRepository()
        {
            ...
            Mapper.Initialize(cfg => cfg.CreateMap<Seller, DALUsers.Seller>()
            ...
            Mapper.Initialize(cfg => cfg.CreateMap<Customer, DALUsers.Customer>()
                .ForMember("Id", opt => opt.MapFrom(c => c.Id))
                .ForMember("Name", opt => opt.MapFrom(src => src.Name))
                .ForMember("Password", opt => opt.MapFrom(src => src.Password))
                .ForMember("Roles_ID", opt => opt.MapFrom(src => src.Roles_ID))
            ...
            Mapper.Initialize(cfg => cfg.CreateMap<Admin, DALUsers.Admin>()
                .ForMember("Id", opt => opt.MapFrom(c => c.Id))
                .ForMember("Name", opt => opt.MapFrom(src => src.Name))
                .ForMember("Password", opt => opt.MapFrom(src => src.Password))
                .ForMember("Roles_ID", opt => opt.MapFrom(src => src.Roles_ID))
        ...
        public Seller GetSeller(int id)
        {
            ...
            return Mapper.Map<DALUsers.Seller, Seller>(this.DAL.GetSellerByID(id));
        }
        ...
        public Seller GetSeller(string login)
        {
            ...
            return Mapper.Map<DALUsers.Seller, Seller>(this.DAL.GetSellerByName(login));
        }
        ...
        public IEnumerable<Seller> GetAllSellers()
        {
            ...
            return Mapper.Map<IEnumerable<DALUsers.Seller>, List<Seller>>(this.DAL.GetSellers());
        }
        ...
        public Customer GetCustomer(int id)
        {
            ...
            return Mapper.Map<DALUsers.Customer, Customer>(this.DAL.GetCustomerByID(id));
        }
        ...
        public Customer GetCustomer(string login)
        {
            ...
            return Mapper.Map<DALUsers.Customer, Customer>(this.DAL.GetCustomerByName(login));
        }
        ...
        public IEnumerable<Customer> GetAllCustomer()
        {
            ...
            return Mapper.Map<IEnumerable<DALUsers.Customer>, List<Customer>>(this.DAL.GetCustomers());
        }
        ...
        public Admin GetAdmin(int id)
        {
            ...
            return Mapper.Map<DALUsers.Admin, Admin>(this.DAL.GetAdminByID(id));
        }
        ...
        public Role GetRole(int id)
        {
            ...
            return Mapper.Map<DALUsers.Role, Role>(this.DAL.GetRole(id));
        }
